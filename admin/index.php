...
?> <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal" class="modal fade">
                                        ...
                                        <form role="form" method="post" action="../includes/addmenu.php">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="menu-name" class="form-control"
                                                    id="exampleInputEmail3" placeholder="Enter menu name..">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Menu Link</label>
                                                <input type="text" name="menu-link" class="form-control"
                                                    id="exampleInputEmail3" value="#" placeholder="Enter menu link..">
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <section class="panel">
                                    <header class="panel-heading"> Menu - <a href="#myModal" data-toggle="modal"
                                            class="text-primary"> Add New Menu</a>
                                    </header>
                                    <table class="table table-striped table-advance table-hover">
                                        <tbody>
                                            <tr>
          ...
          foreach($menus as $menu){
            ?> <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-danger"
                                                            href="../includes/removemenu.php?id=<?=$menu['id']?>">Remove
                                                            <i class="icon_close_alt2"></i></a>
                                                    </div>
                                                </td>
                                            </tr> <?php
                                    ...
                                    <div class="modal-body">
                                        <form role="form" method="post" action="../includes/addmenu.php">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="submenu-name" class="form-control"
                                                    id="exampleInputEmail3" placeholder="Enter menu name..">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Select Parent Menu</label>
                                                <select name="parent-id" class="form-control" id="exampleInputEmail3"> <?php
$mlist = getAllMenu($db);
foreach($mlist as $m){
...
?> </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="submenu-link" class="form-control"
                                                    id="exampleInputEmail3" value="#" placeholder="Enter menu link..">
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <section class="panel">
                                    <header class="panel-heading"> SubMenu - <a href="#myModal1" data-toggle="modal"
                                            class="text-primary"> Add New SubMenu</a>
                                    </header>
                                    <table class="table table-striped table-advance table-hover">
                                        <tbody>
                                            <tr>
          ...
          foreach($submenus as $menu){
            ?> <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-danger"
                                                            href="../includes/removesubmenu.php?id=<?=$menu['id']?>">Remove
                                                            <i class="icon_close_alt2"></i></a>
                                                    </div>
                                                </td>
                                            </tr> <?php
...
?> <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal" class="modal fade">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <section class="panel">
                                    <header class="panel-heading"> Category - <a href="#myModal" data-toggle="modal"
                                            class="text-primary"> Add New Category </a>
                                    </header>
                                    <table class="table table-striped table-advance table-hover">
                                        <tbody>
                                            <tr>
          ...
          foreach($categories as $ct){
            ?> <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-danger"
                                                            href="../includes/removect.php?id=<?=$ct['id']?>">Remove <i
       ...
       ?> <div class="col-lg-12">
                            <section class="panel">
                                <header class="panel-heading"> Add Post </header>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-6">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <select name="post_category" class="form-control"> <?php
$categories = getAllCategory($db);
foreach($categories as $ct){
  ?> <option value="<?=$ct['id']?>"><?=$ct['name']?></option> <?php
}
?> </select>
                                                    </div>
                                                </div>
